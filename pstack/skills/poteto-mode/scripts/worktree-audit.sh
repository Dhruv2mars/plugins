...
# Transcripts dir: passed via PSTACK_TRANSCRIPTS (the harness names the active workspace transcript dir).
slug=$(printf '%s' "$main_wt" | sed 's#^/##; s#/#-#g')
transcripts="${PSTACK_TRANSCRIPTS:?Set PSTACK_TRANSCRIPTS to the active workspace transcript directory}"
now=$(date +%s)
