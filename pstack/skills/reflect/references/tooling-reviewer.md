...
- `Read` tool calls against any `SKILL.md` file (workspace `.zcode/skills/`, user-level `~/.zcode/skills/`, or plugin-installed paths under plugin-installed paths under `~/.zcode/cli/plugins/`)
